...
-   Une **attaque de soutien** via une arme se fait si le porteur est juste derrière le rang combattant et à distance de l’ennemi ≤ à son mouvement. (non Vol), de face
...
1. **Céder du terrain** (recul de 2")
→ Si le total modifié ≤ Commandement
→ OU si vous faites un double 1 (toujours sauvé !)

2. **Retraite en bon ordre** (recul du meilleur de 2D6)
