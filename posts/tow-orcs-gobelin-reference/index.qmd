...
-   Lancer les **Enchantements et Maléfices**. Ne pas oublié la <u id='loi_du_nombre'>Loi du nombre</u>.
    - Waaagh ➜ l'<u id='urticaire_ultime'>urticaire ultime</u> / <u id='lever_dla_mauvaise_lune'>Lever D’La Mauvaise Lune</u> / <u id='leklat_du_soleil_malefikk'>L'Éklat Du Soleil Maléfikk</u> / <u id='on_y_va'>On Y Va !</u> / <u id='malediction_de_mork'>Malédiction de Mork</u>.
    - Élémentaliste  ➜ <u id='appeler_la_tempete'>Appeler la tempete</u> / <u id='fleau_du_metal'>Fleau du metal</u> / <u id='remparts_telluriques'>Remparts telluriques</u>.
...
-   Les [Orques]{style="color:#3a5f0b"} ont `CT3` et des <u id='arc_de_guerre'>Arcs de Guerre</u> lesquelles ont la règle <u id='tir_de_Volee'>Tir de Volée</u> 
-   Les [Gobelins]{style="color:#6b8e23"} ont `CT3` et des <u id='arc_court'>Arcs Court</u> lesquelles ont les règles <u id='tir_rapide'>Tir rapide</u> et <u id='tir_de_Volee'>Tir de Volée</u>.
...
-   **Vortex et projectiles magiques éventuels** en sachant <u id='loi_du_nombre'>Loi du nombre</u> :
    ...
    -   Magie Waagh ➜ <u id='invocation_desprit_elemental'>Invocation desprit elemental</u> / <u id='bourrasque'>Bourrasque</u> 
    
    
<details>

<summary>Détails autres projectiles magiques possibles</summary>
...
-   <u id='tir_rapide'>Tir rapide</u> des <u id='arc_court'>Arcs Court</u> ne subit pas -1 au jet de touche quand ce déplace et tire compte aussi après un ralliement (p 170).
...
-   Si à `6"` d’une unité de `PU5` ou plus qui  <u id='fuite'>fuit</u>, ou se <u id='repli_en_bon_ordre'>repli en bon ordre</u> ou est totalement détruite.
...
-   Sort d’<u id='assaillement'>Assaillement</u> éventuelle:
    -   Magie Waagh ➜ <u id='poing_de_gork'>Poing de Mork</u> & <u id='kraz_tête'>Kraz Tête</u>
    -   Elementalisme ➜  <u id='epee_enflammee'>Epee enflammee</u> 
    -   Other: Illusionnisme ➜ (p 331) 5 Double Spectral, Bataille \> (p 320), Main de Marteau.
...
```{r, echo=FALSE}
# I) ---------------------------------------------------------------------------
rule_avant_garde <- "Avant-garde [Vanguard] : peut faire un mouvement (mais pas de marche forcée) après le déploiement mais si effectué ne peut pas charger au 1er tour." ## TODO not used
...
rule_loi_du_nombre <- "Si ce personnage a rejoint une unité d’Orques ayant une PU de 10 ou plus, il peut appliquer un modificateur de +1 à tout jet de Lancement qu’il effectue. S’il quitte l’unité pour quelque raison que ce soit, ou si la PU de l’unité descend en dessous de 10, ce modificateur est perdu."

rule_assaillement <- "Sorts d’Assaillement: Si un sorcier qui est engagé en combat connait un ou plusieurs sorts d’Assaillement, il peut tenter de les lancer en plus de ses attaques normales quand c’est son tour de combattre, comme déterminé par son Initiative."
...
## Magie Elementaliste
rule_appeler_la_tempete <- "[default Elementaliste] Type : Maléfice / Valeur de Lancement : 7+ / Portée : 12” / Effet : Jusqu’à votre prochaine sous-phase de Début du Tour, l’unité cible ennemie subit un modificateur de -1 à ses caractéristiques de Mouvement et d’Initiative (jusqu’à un minimum de 1). Si ce sort est lancé, les effets de tout autre Maléfice lancé précédemment sur l’unité cible expirent immédiatement."

rule_epee_enflammee <- "[1 Elementaliste] Type : Assaillement / Valeur de Lancement : 6+ / Portée : Combat / Effet : Une seule unité ennemie avec laquelle le lanceur est engagé en combat subit D6+1 touches de Force 3, chacune avec une PA de -. Ces touches ont la règle spéciale Attaques Enflammées." 


rule_fleau_du_metal <- "[2 Elementaliste] Type : Maléfice / Valeur de Lancement : 9+ / Portée : 21” Effet : Jusqu’à votre prochaine sous-phase de Début du Tour, l’unité cible ennemie subit un modificateur de -2 à sa valeur d’armure. Ce sort peut cibler une unité ennemie engagée en combat."

rule_invocation_desprit_elemental <- "[3 Elementaliste] Type : Vortex Magique / Valeur de Lancement : 9+ / Portée : 15” / Effet : Reste en Jeu. Placez un petit (3”) gabarit d’explosion de sorte que le trou central soit à 15” du lanceur. Tant qu’il est en jeu, le gabarit est traité comme du terrain dangereux par-dessus lequel aucune ligne de vue ne peut être tracée. Le gabarit se déplace de D6” dans une direction aléatoire à chaque sous-phase de Début du Tour. Toute unité ennemie que le gabarit mouvant touche subit D3+3 touches de Force 4 chacune avec une PA de -1."

rule_remparts_telluriques <- "[4 Elementaliste] Type : Enchantement / Valeur de Lancement : 10+ / Portée : 15” / Effet : Jusqu’à votre prochaine sous-phase de Début du Tour, l’unité cible amie gagne une sauvegarde invulnérable de 5+ contre toute blessure subie et compte comme étant derrière un obstacle linéaire bas défendu si elle est chargée. Cependant, tant que ce sort est en jeu l’unité ne peut pas faire de marche forcée ni charger."

rule_bourrasque <- "[5 Elementaliste] Type : Projectile Magique / Valeur de Lancement : 8+ / Portée : 15” / Effet : L’unité cible ennemie subit D3+3 touches de Force 5, chacune avec une PA de -1. Une fois ces touches résolues, l’unité doit Céder du Terrain."

rule_passage_mystique <- "[6 Elementaliste] Type : Transfert / Valeur de Lancement : 10+ / Portée : 9” / Effet : Si l’unité cible amie n’est pas en fuite et ne s’est pas déplacée à cette phase de Mouvement, vous pouvez immédiatement la retirer du champ de bataille et la placer n’importe où à 12” de sa position d’origine, mais à plus de 6” de toute figurine ennemie. L’unité cible amie ne peut pas se déplacer de nouveau à cette phase de Mouvement."
...
overview_cd <- "Commandement: <br> Gobs: CD5|6 / Night Gobs: CD 4|5  <br> Orques: CD6|7 / Troll CD4 (CD5 ceux d'eau)  <br> Orques noir: CD8 <br> ~~ Héro ~~ <br> Gobs: CD6|7 / Héro Night Gobs: CD 5|6  <br> Héro Orques: CD7|8 / Héro Orques noir: CD8|9"
...
overview_svg <- "Orques noires: 4|3+* / Orques: 6|5+* <br> Sanglier 4|3+* / Char Sanglier 4+ <br> Gobelin: 6|5+* / Loups: 7|6*|5°+ <br> Squig: 7+|6° <br> [* ➜ Bouclier] & [°➜ Armure légère payante]"
...
# Apply ------------------------------------------------------------------------
tippy::tippy_this(elementId = "avant_garde", tooltip = rule_avant_garde) #TODO not used
...
tippy::tippy_this(elementId = "loi_du_nombre", tooltip = rule_loi_du_nombre)
tippy::tippy_this(elementId = "dissipation", tooltip = rule_dissipation)
tippy::tippy_this(elementId = "assaillement", tooltip = rule_assaillement)
...
tippy::tippy_this(elementId = "appeler_la_tempete" , tooltip = rule_appeler_la_tempete) # Elementalisme p326
tippy::tippy_this(elementId = "epee_enflammee" , tooltip = rule_epee_enflammee) # Elementalisme p326
tippy::tippy_this(elementId = "fleau_du_metal" , tooltip = rule_fleau_du_metal) # Elementalisme p326
tippy::tippy_this(elementId = "invocation_desprit_elemental" , tooltip = rule_invocation_desprit_elemental) # Elementalisme p326
tippy::tippy_this(elementId = "remparts_telluriques" , tooltip = rule_remparts_telluriques) # Elementalisme p326
tippy::tippy_this(elementId = "bourrasque" , tooltip = rule_bourrasque) # Elementalisme p326
tippy::tippy_this(elementId = "passage_mystique" , tooltip = rule_passage_mystique) # Elementalisme p326
